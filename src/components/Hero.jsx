      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="fade-up flex-shrink-0 flex items-center justify-center">
          ...
          <div className="relative w-72 h-72 md:w-80 md:h-80">
            ...
            <div className="absolute inset-0 rounded-full border-2 border-dashed border-blue-500/30 animate-spin [animation-duration:12s]" />
            {/* Inner border ring */}
            ...
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-neutral-900 border border-white/10 text-xs text-green-400 whitespace-nowrap shadow-lg">
